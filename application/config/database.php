...
//For opencart database connection
$db['wordpress']['hostname'] = 'localhost';
$db['wordpress']['username'] = 'root';
$db['wordpress']['password'] = '';
$db['wordpress']['database'] = 'res';
...
$db['wordpress']['stricton'] = FALSE;/* End of file database.php */
